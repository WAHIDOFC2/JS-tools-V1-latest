...
spawn('termux-open-url', ['https://wa.me/62895393974879?text=Assalamualaikum+bang']);
break;
}

case "gh": {
console.log(chalk.green.bold("Menuju github dev"));
spawn('termux-open-url', ['https://github.com/WAHIDOFC2']);
break;
}

case "ch": {
console.log(chalk.green.bold("Menuju channel dev"));
spawn('termux-open-url', ['https://whatsapp.com/channel/0029VawJmjVKgsNuANC9zR0e']);
break;
}
case "fetch": {
	var tek = params[0];
